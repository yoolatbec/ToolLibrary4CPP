...
bool LinkedList::add(const Reference& ref){
	...
	((LinkedListNode*)(((LinkedListNode*)node.getEntity())->previous.getEntity()))->next = node;
...
bool LinkedList::addFirst(const Reference& ref){
	...
	((LinkedListNode*)node.getEntity())->next = ((LinkedListNode*)head.getEntity())->next;
	((LinkedListNode*)head.getEntity())->next = node;
	((LinkedListNode*)(((LinkedListNode*)node.getEntity())->next.getEntity()))->previous = node;
...
bool LinkedList::addAllFirst(const Reference& ref){
	...
	while(iterator->hasNext()){
		...
		((LinkedListNode*)newNode.getEntity())->next = ((LinkedListNode*)current.getEntity())->next;
		((LinkedListNode*)current.getEntity())->next = newNode;
		((LinkedListNode*)(((LinkedListNode*)newNode.getEntity())->next.getEntity()))->previous = newNode;
