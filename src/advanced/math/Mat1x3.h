...
#ifndef ADVANCED_MATH_MAT1X3_H_
#define ADVANCED_MATH_MAT1X3_H_
...
private:
	...
	const static MATRIX_TYPE MATRIX_ARRANGEMENT = MATRIX_1X3;
	...
	const static mat1x3 DEFAULT_VALUE = { { 0, 0, 0 } };
