...
#ifndef ADVANCED_MATH_MAT2X4_H_
#define ADVANCED_MATH_MAT2X4_H_
...
private:
	...
	const static MATRIX_TYPE MATRIX_ARRANGEMENT = MATRIX_2X4;
	...
	const static mat2x4 DEFAULT_VALUE = { { 0, 0, 0, 0 }, { 0, 0, 0, 0 } };
